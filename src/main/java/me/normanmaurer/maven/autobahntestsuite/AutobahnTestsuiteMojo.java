...
@Mojo(name = "autobahntestsuite", defaultPhase = LifecyclePhase.INTEGRATION_TEST)
public class AutobahnTestsuiteMojo
    ...
    public void execute()
        ...
        if (mainClass != null) {
            try {
                Class.forName(mainClass).newInstance();
            } catch (Exception e) {
                throw new MojoExecutionException("Unable to start server from class " + mainClass, e);
            }
        }
